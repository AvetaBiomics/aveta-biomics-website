...
export default function SciencePage(){return <Shell active="/science"><main>
  ...
  <section className="container science-podcast"><div><p className="eyebrow">FEATURED PODCAST</p><h2>Science Behind Aveta’s Immunotherapy</h2><p>Conversation about Aveta’s approach to reprogramming the tumor immune microenvironment.</p></div><a className="button" href="https://open.spotify.com/episode/6mE4tWcFY33fwBxDOc89um?si=YvB9FxpZRryk3FKK_JUJ0Q&amp;nd=1&amp;dlsi=5ee8629ea6664af8" target="_blank" rel="noopener noreferrer" aria-label="Listen to Science Behind Aveta’s Immunotherapy, opens in a new tab">Listen</a></section>
  ...
  <section className="section-sm"><div className="container publication-cta"><div><h2>Read Our Publications</h2><p>Explore the peer-reviewed science behind Aveta’s platform and APG-157.</p><a className="button" href="/publications">View Publications <Arrow /></a></div></div></section>
</main></Shell>}
